...
class Generator(nn.Module):
    def __init__(self, params):
        ...
        self.fc2 = nn.Linear(2000, 64*64*3)
    ...
    def forward(self, z, c):
        ...
        '''
        x = F.relu(self.fc1(z.reshape(-1,100)))
        x = F.tanh((self.fc2(x))).reshape(-1, 3, 64, 64)
        '''
        return x, z
...
class Discriminator(nn.Module):
    def __init__(self, params):
        ...
        self.fc1 = nn.Linear(64*64*3, 2000)
    ...
    def forward(self, x):
        ...
        '''
        x = F.leaky_relu(self.fc1(x.view(-1, 64*64*3)), 0.2, True)
